import csv
import datetime
from apps.reports.models import CovidRegister, Location
...
class Utils:
    ...
    def save_data(self, args):
        ...
        saved_locations = Location.objects.all()
        if(saved_locations.filter(location=args['location']).count() == 0):
            ...
            location = Location.objects.get(location=args['location'])
